...
describe('DonationsReceived Management Component', () => {
  let comp: DonationsReceivedComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'donations-received', component: DonationsReceivedComponent }]),
      ...
      .overrideTemplate(DonationsReceivedComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.donationsReceiveds?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
