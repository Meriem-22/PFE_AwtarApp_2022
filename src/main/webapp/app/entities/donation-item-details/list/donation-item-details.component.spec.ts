...
describe('DonationItemDetails Management Component', () => {
  let comp: DonationItemDetailsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'donation-item-details', component: DonationItemDetailsComponent }]),
        HttpClientTestingModule,
      ],
      declarations: [DonationItemDetailsComponent],
      providers: [
        {
      ...
      .overrideTemplate(DonationItemDetailsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.donationItemDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
