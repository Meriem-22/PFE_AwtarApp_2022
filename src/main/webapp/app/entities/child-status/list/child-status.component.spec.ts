...
describe('ChildStatus Management Component', () => {
  let comp: ChildStatusComponent;
  let fixture: ComponentFixture<ChildStatusComponent>;
  let service: ChildStatusService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'child-status', component: ChildStatusComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ChildStatusComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.childStatuses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
