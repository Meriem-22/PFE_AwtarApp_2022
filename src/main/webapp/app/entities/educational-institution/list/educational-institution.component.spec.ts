...
describe('EducationalInstitution Management Component', () => {
  let comp: EducationalInstitutionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'educational-institution', component: EducationalInstitutionComponent }]),
      ...
      .overrideTemplate(EducationalInstitutionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.educationalInstitutions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
