...
describe('Nature Management Component', () => {
  let comp: NatureComponent;
  let fixture: ComponentFixture<NatureComponent>;
  let service: NatureService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'nature', component: NatureComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(NatureComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.natures?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
