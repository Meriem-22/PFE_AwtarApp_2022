...
describe('Nature Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      name: 'AAAAAAA',
      destinedTo: Beneficiaries.FAMILY,
      necessityValue: false,
      archivated: false,
    };
  });
  ...
  describe('Service methods', () => {
    ...
    describe('addNatureToCollectionIfMissing', () => {
      ...
      it('should add only unique Nature to an array', () => {
        const natureArray: INature[] = [{ id: 123 }, { id: 456 }, { id: 23562 }];
      ...
      it('should return initial array if no Nature is added', () => {
        const natureCollection: INature[] = [{ id: 123 }];
        expectedResult = service.addNatureToCollectionIfMissing(natureCollection, undefined, null);
        expect(expectedResult).toEqual(natureCollection);
      });
    });
  });
