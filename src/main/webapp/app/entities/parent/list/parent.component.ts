...
export class ParentComponent implements OnInit {
  ...
  trackId(_index: number, item: IParent): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IParent[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
