...
export class VisitComponent implements OnInit {
  ...
  trackId(_index: number, item: IVisit): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IVisit[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
