...
describe('DonationDetails Management Component', () => {
  let comp: DonationDetailsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'donation-details', component: DonationDetailsComponent }]),
      ...
      .overrideTemplate(DonationDetailsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.donationDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
