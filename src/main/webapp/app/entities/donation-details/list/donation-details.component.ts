...
export class DonationDetailsComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.donationDetailsService
      ...
      .subscribe({
        next: (res: HttpResponse<IDonationDetails[]>) => {
  ...
  trackId(_index: number, item: IDonationDetails): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IDonationDetails[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
