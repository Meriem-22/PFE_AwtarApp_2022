...
describe('EstablishmentType Management Component', () => {
  let comp: EstablishmentTypeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'establishment-type', component: EstablishmentTypeComponent }]),
      ...
      .overrideTemplate(EstablishmentTypeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.establishmentTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
