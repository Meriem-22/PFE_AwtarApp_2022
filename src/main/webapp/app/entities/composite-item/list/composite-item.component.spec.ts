...
describe('CompositeItem Management Component', () => {
  let comp: CompositeItemComponent;
  let fixture: ComponentFixture<CompositeItemComponent>;
  let service: CompositeItemService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'composite-item', component: CompositeItemComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CompositeItemComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.compositeItems?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
