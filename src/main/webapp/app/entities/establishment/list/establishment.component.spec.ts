...
describe('Establishment Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'establishment', component: EstablishmentComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.establishments?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
