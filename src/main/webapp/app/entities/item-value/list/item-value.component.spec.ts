...
describe('ItemValue Management Component', () => {
  let comp: ItemValueComponent;
  let fixture: ComponentFixture<ItemValueComponent>;
  let service: ItemValueService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'item-value', component: ItemValueComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ItemValueComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.itemValues?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
