...
export class ItemValueComponent implements OnInit {
  ...
  trackId(_index: number, item: IItemValue): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IItemValue[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
